(function ($, Drupal) {
    Drupal.behaviors.web3Login = {
      attach: function (context, settings) {

        var web3LoginButton = $('#web3loginConnect', context);
        ...
        var checkNetwork = async function() {
            const chainId = drupalSettings.web3login.network;
        ...
        async function signMessage() {
            const message = 'Allow login at ' + nonce;
            try {
